    ...
    >
      ...
      >
          ...
          >
            ...
            >
              <div>
                ...
                <span className="header-text">មន្ទីរពេទ្យខេត្តស្ទឹងត្រែង</span>
                <br />
              </div>
              <div>
                <QrWithIcon
        ...
        <div className="print-content">
          ...
          <p>
            • ថ្ងៃខែឆ្នាំកំណើត: <b>{dayjs(data.dob).format("DD-MM-YYYY")} </b>
          ...
          <p>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp; • កន្លែងធ្វើការ: <b>{data.workplace}</b>{" "}
          </p>
          <p>
          ...
          <p>
            • លេខទូរស័ព្ទ : <b>{data.phone1 || "............."}</b> / អ៊ីម៉ែល:{" "}
            {data.email1 || "................."}
          </p>
          <p>(សូមមេត្តាអានដោយយកចិត្តទុកដាក់ និងបំពេញសំណួរសុខភាពនៅទំព័រក្រោយ)</p>
          ...
          {!sigle && (
            <>
              {dataArray.length === 0 ? (
                <div className="print-content" style={{ marginBottom: "20px" }}>
                  ...
                  <Row gutter={16}>
                    <Col span={12}>
                      <span>• សម្ពាធឈាម : ....../ ...... មីលីម៉ែត្របារ៉ត</span>
                    </Col>
                    <Col span={12}>
                  ...
                  <Row gutter={16}>
                    ...
                    <Col span={18}>
                      ...
                      <br />
                      <span>
                        មូលហេតុ: □ អេម៉ូក្លូប៊ីន ឬ អេម៉ាតូគ្រីត / □ សម្ពាធឈាម /
                        □ ទម្ងន់ / □ ប្រវត្តិជំងឺ <br />□ ស្ថានភាពប្រឈមមុខ / □
                        អាយុ / □ មុនកាលកំណត់ / □ ផ្សេងទៀត <br />
                      </span>
                      <span>
                        • បញ្ហាផ្សេងៗ:
                        .........................................................................
                ...
                dataArray.map((item, index) => (
                  ...
                  >
                    ...
                    <Row gutter={16}>
                      ...
                      <Col span={12}>
                        <span>
                          • លេខកូដកន្លែង : ...<b>{dataDonor?.donator_code}</b>
                          ...
                        </span>
                      </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                      <Col span={12}>
                        <span>
                          • ជីពចរ : ...<b>{item.pulse_rate}</b>... ក្នុង១នាទី
                        </span>
                      </Col>
                      <Col span={12}>
                        <span>
                    ...
                    <Row gutter={16}>
                      ...
                      <Col span={18}>
                        <span>
                          ...
                          &nbsp;&nbsp;
                          {isChecked("cSD", item.donor_type) ? "☑" : "□"} cSD
                          &nbsp;&nbsp;
